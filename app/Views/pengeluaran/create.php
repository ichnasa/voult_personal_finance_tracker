  ...
  <div class="card card-primary">
    ...
    <form action="<?= base_url('pengeluaran/store') ?>" method="post" enctype="multipart/form-data">
      ...
      <div class="card-body">
        ...
        <div class="form-group"><label for="catatan">Catatan <small class="text-muted">(opsional)</small></label>
          <textarea id="catatan" name="catatan" class="form-control" rows="3" placeholder="Catatan tambahan..."><?= old('catatan') ?></textarea>
        </div>
        <div class="form-group"><label for="nota">Upload Nota <small class="text-muted">(opsional)</small></label>
