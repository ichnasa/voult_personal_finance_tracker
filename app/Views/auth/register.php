...
<div class="card card-md">
  <div class="card-body">
    ...
    <!-- Google OAuth Button (top, faster registration) -->
    <a href="<?= base_url('auth/google') ?>" class="btn w-100 mb-3" style="background: #fff; border: 1px solid #dadce0; color: #3c4043; font-weight: 500;">
    ...
    <!-- Divider -->
    <div class="hr-text my-3">atau daftar manual</div>
