...
<div class="card card-md">
  <div class="card-body">
    <h2 class="h2 text-center mb-4">Verifikasi OTP Reset Password</h2>
    <p class="text-center text-secondary mb-4">
      Masukkan 6 digit kode OTP yang telah dikirimkan ke email Anda untuk melanjutkan reset password.
    </p>
    ...
    <form action="<?= base_url('auth/processResetOtp') ?>" method="post" autocomplete="off">
      <?= csrf_field() ?>
    ...
    <div class="text-center mt-3">
        <a href="<?= base_url('auth/resendResetOtp') ?>" class="text-secondary">Kirim Ulang OTP</a>
    </div>
  </div>
</div>
