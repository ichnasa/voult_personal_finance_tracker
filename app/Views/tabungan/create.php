  ...
  <div class="card card-primary">
    ...
    <form action="<?= base_url('tabungan/store') ?>" method="post">
      ...
      <div class="card-body">
        ...
        <?php endif; ?>
        <div class="form-group"><label>Nama Tabungan</label>
        ...
        <div class="row">
          <div class="col-md-6"><div class="form-group"><label>Target Nominal (Rp)</label>
            <input type="number" name="target_nominal" class="form-control" placeholder="0" value="<?= old('target_nominal') ?>" min="1" required>
          </div></div>
          <div class="col-md-6"><div class="form-group"><label>Nominal Awal (Rp)</label>
            <input type="number" name="nominal_terkumpul" class="form-control" placeholder="0" value="<?= old('nominal_terkumpul') ?: '0' ?>" min="0">
          </div></div>
        </div>
        <div class="row">
          <div class="col-md-6"><div class="form-group"><label>Deadline <small class="text-muted">(opsional)</small></label>
            <input type="date" name="deadline" class="form-control" value="<?= old('deadline') ?>">
          </div></div>
          <div class="col-md-6"><div class="form-group"><label>Hubungkan Wishlist <small class="text-muted">(opsional)</small></label>
      ...
      <div class="card-footer">
        ...
        <a href="<?= base_url('tabungan') ?>" class="btn btn-default ml-2">Batal</a>
      </div>
    </form>
  </div>
</div></div>
