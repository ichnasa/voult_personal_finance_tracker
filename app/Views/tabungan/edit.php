  ...
  <div class="card card-primary">
    ...
    <form action="<?= base_url('tabungan/update/' . $item['id']) ?>" method="post">
      ...
      <div class="card-body">
        ...
        <div class="row">
          <div class="col-md-4"><div class="form-group"><label>Target Nominal (Rp)</label>
            <input type="number" name="target_nominal" class="form-control" value="<?= old('target_nominal') ?: $item['target_nominal'] ?>" min="1" required>
          </div></div>
          <div class="col-md-4"><div class="form-group"><label>Nominal Terkumpul (Rp)</label>
        ...
        <div class="row">
          <div class="col-md-6"><div class="form-group"><label>Deadline</label>
            <input type="date" name="deadline" class="form-control" value="<?= old('deadline') ?: $item['deadline'] ?>">
          </div></div>
          <div class="col-md-6"><div class="form-group"><label>Hubungkan Wishlist</label>
