...
$routes->get('auth/register-otp', 'Auth::registerOtp');
$routes->post('auth/processRegisterOtp', 'Auth::processRegisterOtp');
$routes->get('auth/resendRegisterOtp', 'Auth::resendRegisterOtp');
